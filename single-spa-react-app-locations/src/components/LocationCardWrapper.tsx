    ...
    >
      ...
      <Box padding="1rem">
        <Text data-testid="location-card-wrapper-name-explanation">
          This is a {type} located in {dimension}. There are total of{" "}
          {residents.length} residents that are originated from here.
        </Text>
      </Box>
      <SimpleGrid columns={4} spacing={4} padding="1rem">
        ...
        <Button
          ...
          display={
            counter === totalPage || residents.length === 0 ? "none" : ""
          }
